...
urlpatterns = [
    ...
    url(r'^modal-show-individual-crystal/(?P<crystal_id>[0-9]+)/$', views.modal_show_individual_crystal,
        name='modal-show-individual-crystal'),
    ...
    url(r'^crystal-detail-page/(?P<mask_id>[0-9]+)/$', views.crystal_detail_page, name='crystal-detail-page')
